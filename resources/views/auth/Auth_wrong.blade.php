    ...
    <section class="not-found mx-auto pt-145 pb-md-212 pb-100">
        <div class="container-fluid">
            <div class="text-center">
                <svg class="img-fluid mt-5" width="483" height="300" viewBox="0 0 483 300" fill="none"
            ...
            <div class="pt-70 pb-md-50 pb-150">
                <h2 class="text-4xl mt-5 fw-bold text-center color-palette-1 mb-10">Wrong Password</h2>
                <p class="text-lg mt-4 text-center color-palette-1 m-0">Password atau NIK anda salah</p>
            </div>
            <div class="button-group d-flex mt-3 flex-column mx-auto">
                <a class="btn btn-homepage fw-medium text-lg text-white rounded-pill" onclick="history.back()"
                    role="button">Login</a>
            </div>
        </div>
    </section>
