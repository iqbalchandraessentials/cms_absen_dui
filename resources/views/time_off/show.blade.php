                ...
                <div class="card-body" style="padding-bottom: 0">
                    <div class="row ">
                        <div class=" col-md-3 col-lg-6">
                            <h3 class="text" style="font-weight: bold; margin:0 "> Timeoff
                        ...
                        <div class="col-lg-12">
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Jenis Cuti</td>
                                        <td> {{$data->timeoff->name}} ({{$data->timeoff->code}})</td>
                                    </tr>
                                       <tr> <td>Durasi</td>
                                        <td> <b>{{ date('d-M-Y', strtotime($data->start_date)) }}</b> -  <b>{{date('d-M-Y', strtotime($data->end_date))}}</b> </td>
                                    </tr>
                                    </tr>
                                    <tr> <td>Request Date</td>
                                       ...
                                       <tr> <td>Approve By</td>
                                        ...
                                        <tr>
                                        <td>Approve Date</td>
                                        <td>  @if ($data->approve_date)
                                            {{  date('Y-m-d H:i', strtotime($data->approve_date)) }}
                                            @else
                                            -
                                            @endif</td>
                                    </tr>
                    ...
                    <div class="col-12 mt-2">
                        ...
                        <div class="row mt-5 mb-5">
                            ...
                            <div class="col">
                                <a href="{{ asset("uploads/timeoff/".$x->upload_file) }}" target="_blank" rel="noopener noreferrer">
                                    <img src="{{ asset("uploads/timeoff/".$x->upload_file) }}" class="img-fluid w-80" alt="" srcset="">
                                </a>
                            </div>
                            @empty
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.timeoff', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-9">
